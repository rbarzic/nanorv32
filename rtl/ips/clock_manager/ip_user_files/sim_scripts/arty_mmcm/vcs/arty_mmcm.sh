...
reset_run()
{
  files_to_remove=(ucli.key arty_mmcm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc arty_mmcm_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.arty_mmcm xil_defaultlib.glbl -o arty_mmcm_simv
}
...
simulate()
{
  ...
  ./arty_mmcm_simv $opts -do simulate.do
}
# Script usage
usage()
{
