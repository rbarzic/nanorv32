...
if [ -z "$PATH" ]; then
  PATH=/opt/Xilinx/Vivado/2015.3/ids_lite/ISE/bin/lin64:/opt/Xilinx/Vivado/2015.3/bin
else
  PATH=/opt/Xilinx/Vivado/2015.3/ids_lite/ISE/bin/lin64:/opt/Xilinx/Vivado/2015.3/bin:$PATH
fi
export PATH
...
EAStep vivado -log arty_mmcm.vds -m64 -mode batch -messageDb vivado.pb -notrace -source arty_mmcm.tcl
