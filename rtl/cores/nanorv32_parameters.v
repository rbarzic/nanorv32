...
parameter NANORV32_DECODE_FENCE = 35'b???0000????????00000000?????0001111;
parameter NANORV32_DECODE_SLTI = 35'b????????????????????010?????0010011;
parameter NANORV32_DECODE_C_ADDI = 35'b???????????????????100???????????10;
...
parameter NANORV32_DECODE_SCALL = 35'b???00000000000000000000?????1110011;
parameter NANORV32_DECODE_FENCE_I = 35'b???0000????????00000001?????0001111;
...
parameter NANORV32_DECODE_C_LI = 35'b??0????????????????010???????????10;
...
parameter NANORV32_DECODE_C_NOP = 35'b1?1????????????????000???????????10;
...
parameter NANORV32_DECODE_C_LUI = 35'b?0?????????????????011???????????10;
parameter NANORV32_DECODE_C_AND = 35'b?????????????????????????????????10;
parameter NANORV32_DECODE_SBREAK = 35'b???00000000000100000000?????1110011;
...
parameter NANORV32_MUX_SEL_REGFILE_PORTW_RS1_P = 1;
parameter NANORV32_MUX_SEL_REGFILE_PORTW_RS1 = 2;
//  regfile_source
...
parameter NANORV32_MUX_SEL_REGFILE_PORT1_RS1_P = 0;
