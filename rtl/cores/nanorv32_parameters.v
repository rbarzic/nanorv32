...
parameter NANORV32_DECODE_C_OR = 35'b?????????????????????????????????01;
...
parameter NANORV32_DECODE_C_SRAI = 35'b???????????????????100???????????01;
parameter NANORV32_DECODE_SRAI = 35'b???0100000??????????101?????0010011;
parameter NANORV32_DECODE_C_XOR = 35'b?????????????????????????????????01;
...
parameter NANORV32_DECODE_C_ANDI = 35'b???????????????????100???????????01;
...
parameter NANORV32_DECODE_C_SRLI = 35'b???????????????????100???????????01;
...
parameter NANORV32_DECODE_C_SUB = 35'b?????????????????????????????????01;
...
parameter NANORV32_DECODE_C_AND = 35'b?????????????????????????????????01;
