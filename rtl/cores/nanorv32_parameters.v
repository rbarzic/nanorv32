...
parameter NANORV32_DECODE_FENCE = 32'b000000000000?????000000000001111;
parameter NANORV32_DECODE_SLTI = 32'b?????????????????010?????0010011;
parameter NANORV32_DECODE_RDCYCLEH = 32'b11001000000000000010?????1110011;
parameter NANORV32_DECODE_SBREAK = 32'b000000000001?????000000001110011;
...
parameter NANORV32_DECODE_MULHU = 32'b0000001??????????011?????0110011;
parameter NANORV32_DECODE_RDTIME = 32'b11000000000100000010?????1110011;
...
parameter NANORV32_DECODE_SCALL = 32'b000000000000?????000000001110011;
parameter NANORV32_DECODE_FENCE_I = 32'b000000000000?????001000000001111;
...
parameter NANORV32_DECODE_REM = 32'b0000001??????????110?????0110011;
parameter NANORV32_DECODE_LUI = 32'b?????????????????????????0110111;
parameter NANORV32_DECODE_BNE = 32'b?????????????????001?????1100011;
parameter NANORV32_DECODE_RDCYCLE = 32'b11000000000000000010?????1110011;
parameter NANORV32_DECODE_RDTIMEH = 32'b11001000000100000010?????1110011;
parameter NANORV32_DECODE_MULH = 32'b0000001??????????001?????0110011;
parameter NANORV32_DECODE_BGEU = 32'b?????????????????111?????1100011;
parameter NANORV32_DECODE_RDINSTRETH = 32'b11001000001000000010?????1110011;
...
parameter NANORV32_DECODE_MULHSU = 32'b0000001??????????010?????0110011;
...
parameter NANORV32_DECODE_DIVU = 32'b0000001??????????101?????0110011;
...
parameter NANORV32_DECODE_REMU = 32'b0000001??????????111?????0110011;
